...
def execute_inference(com1,com2,nearest):
    ...
    * nearest: choose the start point to compress
    ...
    for listname in listnames:
        ...
        # start to prune
        os.system('./scripts/run_local.sh nets/'+ net_name +'_at_ilsvrc12_run.py  \ --learner channel \ --cp_prune_option list \ --cp_prune_list_file ./ratio.list \ --save_step 6000  \ --enbl_warm_start True') # 4000
